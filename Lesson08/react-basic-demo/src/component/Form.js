...
class Form extends Component{
    ...
    componentWillMount=()=>{
      // vào trước khi render trong quá trình mounting
      let {student} = this.props;
      if(this.props.actionName === "Thêm"){
        this.setState({
          studentId:"", 
          studentName:"",
          age:"", 
    ...
    handleClickSubmit = ()=>{
      ...
      }else if(actionName === "Sửa"){// Cập nhật cho trường hợp sửa
        console.log(studentNew);
        this.props.handleClickEdit(false,studentNew);
      }else{ // xem
